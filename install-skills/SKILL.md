...
3. **git-commit** — Conventional Commits 커밋 메시지 작성
4. **git-pr** — PR 제목/메시지 작성 (비즈니스+테크 관점)
5. **git-qa** — 배포 대상 PR에서 repo별 QA 체크리스트 생성
6. **git-review** — 비즈니스/테크 리뷰 수행
7. **git-review-context** — 리뷰 전 변경사항 사전 분석
8. **issue-audit** — 이슈 스펙 대비 구현 독립 감사
9. **issue-work** — 이슈 단위 스펙/계획/요약 관리
10. **sync-readme** — README.md 생성/재작성
