<!-- 반례 fixture: permalink 에 줄 앵커가 없다 (R2, --comment 모드). -->
...
위치: `issue-work/scripts/check-clear.sh:60-72` ([permalink](https://github.com/scroogy-dev/scroogy-agent-skills/blob/0123456789abcdef0123456789abcdef01234567/issue-work/scripts/check-clear.sh))
...
위치: `issue-work/scripts/check-clear.sh:44` (base) ([permalink](https://github.com/scroogy-dev/scroogy-agent-skills/blob/89abcdef0123456789abcdef0123456789abcdef/issue-work/scripts/check-clear.sh))
