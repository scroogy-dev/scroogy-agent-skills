<!-- 반례 fixture: permalink 가 커밋 SHA 대신 브랜치명을 가리킨다 (R2, --comment 모드). -->
...
위치: `issue-work/scripts/check-clear.sh:60-72` ([permalink](https://github.com/scroogy-dev/scroogy-agent-skills/blob/main/issue-work/scripts/check-clear.sh#L60-L72))
...
위치: `issue-work/scripts/check-clear.sh:44` (base) ([permalink](https://github.com/scroogy-dev/scroogy-agent-skills/blob/main/issue-work/scripts/check-clear.sh#L44))
