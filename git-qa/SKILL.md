...
- **스킬 고유 추가 참조**:
  - `.ai/40_domain/specs/` — 관련 spec이 있으면 해당 기준을 테스트 항목에 반영
...
`.ai/40_domain/specs/`에 관련 spec이 있으면 해당 기준을 테스트 항목에 반영하여 정확도를 높입니다.
...
QA 이슈 링크가 제공된 경우, 해당 이슈의 body를 아래 템플릿 구조로 업데이트합니다.
