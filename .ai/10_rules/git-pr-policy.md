...
* **목적 및 요약:** 이 이슈가 해결하고자 하는 비즈니스 요구사항, 버그, 또는 사용자 가치를 명확히 기재한다. (무엇을, 왜 변경했는가?)
* **주요 변경 사항:** 사용자 경험이나 정책 등 비즈니스 관점에서 어떤 변화가 발생했는지 2~3개의 불릿 포인트로 작성한다.
* **참고사항:** 관련된 기획 문서, 비즈니스 룰, 또는 인증 심사(컴플라이언스)와 관련된 필수 요구사항이 있다면 명시한다.
