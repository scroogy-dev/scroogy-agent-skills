...
> ▶️ 다음 작업: Task 0 — 구현 시작 게이트 (전제·모호점 확인)
...
- **특이 사항**: 설계 단계(2026-08-07)에서 이슈 #74의 미결 논점 2건(정리 타이밍 A+B 병행, `--clear` 댓글 동일 규칙 적용)을 사용자 질의로 선해소하고 spec 전제에 기록함 — 구현 착수 시 잔여 모호점만 점검하면 된다.
