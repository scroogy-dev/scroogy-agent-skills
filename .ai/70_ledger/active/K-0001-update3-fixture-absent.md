...
- **채택하지 않은 대안**: `70_ledger/` 한 행만 fixture로 고정 — 이웃 3건(`50_adr/index.md`, `40_domain/index.md`, `40_domain/glossary.md`)이 같은 규칙에 의존하는데 한 건만 덮으면 비대칭 방어가 되어 실익이 낮다.
