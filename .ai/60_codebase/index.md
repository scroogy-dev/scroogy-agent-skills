...
- [표기·명명 관례](../40_domain/policies/local/notation-conventions.md): 분류 값 한글 우선 병기, 모델 기록 "벤더, 모델명 (모델 ID)", 트리 정렬, 이모지는 산출물 값 명세에만, 스킬·옵션 이름은 사용자 의도 기준
